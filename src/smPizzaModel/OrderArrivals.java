...
class OrderArrivals extends ScheduledAction {
	...
	public void actionEvent() {
		...
		model.print("New Order | Number of Pizzas: " + iCOrder.uNumPizzas);
	}

	// RVP
	/* Random Variate Procedure for Arrivals */
	static private final double MINPEAKLENGTH = 15, MAXPEAKLENGTH = 20, MINPEAKORDERS = 20, MAXPEAKORDERS = 60,
			MINOFFPEAKORDERS = 5, MAXOFFPEAKORDERS = 20, PEAKSTARTMEAN = 90.5, PEAKSTARTSDEV = 52.1;
